...
<template>
  <div class="flex h-screen flex-col">
    ...
    <header class="flex-none border-b border-outline-gray-1 bg-surface-base">
      <!-- The bar spans the window; its contents sit in the page container, so the
           logo starts on the same line as the search field below it. -->
      <div class="mx-auto flex w-full max-w-[1100px] items-center gap-4 px-6 py-2">
    ...
    <!-- One page container, centred with even gutters (#449): the list is a
         reading column like Gameplan's, not a run of rows stretched across a
         monitor. Every child aligns to its edges — search on the left, the
